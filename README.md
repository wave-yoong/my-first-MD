...
- Other types of chatbots
    ...
    - **Voice-based** chatbot: These chatbots use voice interfaces instead of text, making them more accessible to a broader range of users, including the elderly and people with disabilities.
        ...
        - Prominent examples include Apple's *Siri* and Amazon's *Alexa*. [^11]
...
A good chatbot is one that **effectively understands user queries, provides accurate and helpful responses, and can handle a range of conversational scenarios**. Key features include natural language understanding, context retention, omnichannel support, and the ability to integrate with existing systems. Additionally, a good chatbot should be able to learn from interactions and improve its performance over time. 

Here's a more detailed breakdown of what makes a good chatbot [^12][^13]:
1. **Natural Language Understanding (NLU)**: A good chatbot needs to be able to understand the nuances of human language, including different ways of asking the same question, slang, and slang terms. 
2. **Context Retention**: It should remember previous turns in a conversation and use that context to provide more relevant and accurate responses. 
3. **Omnichannel** Support: The chatbot should be able to handle conversations across multiple channels, such as websites, mobile apps, social media, and messaging platforms. 
4. **Seamless Integration**: It should integrate smoothly with existing systems and databases, allowing it to access and update information as needed. 
5. **Learning and Improvement**: A good chatbot should be able to learn from its interactions with users and improve its performance over time. 
6. **Helpful and Accurate** Responses: It should provide users with accurate and helpful information, addressing their queries effectively. 
7. **Clear and Engaging** Communication: The chatbot should communicate in a way that is clear, engaging, and easy to understand, avoiding jargon or technical terms. 
8. **Proactive** Engagement: A good chatbot can proactively engage users, offering assistance or information when it's needed. 
...
The rush to implement the technologies has led to numerous *bad chatbot examples* that highlight the importance of careful development and deployment. These chatbot fails can stem from a variety of issues, including **lack of understanding of customer needs, insufficient testing, or a failure to integrate human-like interaction**. [^14]

1. The **Inarticulate assistant**
...
Chatbots deployed in multilingual contexts often struggle to deliver consistent service across languages, resulting in confused and frustrated users.
...
![Lee Luda chatbot](https://github.com/wave-yoong/my-first-MD/blob/main/Bad%20chatbot_Luda.png?raw=true)
...
[^9]: [Hyundai Card chatbot](https://www.hyundaicard.com/cpu/cs/CPUCS0201_01.hc)
[^10]: [Hybrid chatbot](https://www.upstage.ai/blog/ko/ai-chatbots-for-business)
[^11]: [Siri](https://www.apple.com/siri/#:~:text=Get%20everyday%20tasks%20done%20using%20only%20your,request.%20Built%20into%20all%20your%20Apple%20devices.)
[^12]: [good chatbot factors](https://getzowie.com/blog/what-makes-good-chatbot-nine-must-have-features)
[^13]: [good chatbot features](https://www.socialintents.com/blog/ai-chatbot-features/)
[^14]: [Bad chatbot features](https://trengo.com/blog/bad-chatbot-examples)
